...
def transition_path(result, current_lane, target_lane):
    """Return a gentle path just across MIDDLE before final lane centering."""
    ...
    # Aim only 15% beyond the divider. After the divider crosses the camera
    # centre, the controller can switch to the final lane-centre path.
    cross_fraction = 0.15
    return {
